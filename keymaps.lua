...
local keys = {
	...
	{ key = "r", mods = "LEADER", action = act.SplitPane({ direction = "Right", size = { Percent = 30 } }) },
	{ key = "R", mods = "LEADER", action = act.SplitHorizontal({ domain = "CurrentPaneDomain" }) }, -- Control+q → r 横分割
	{ key = "d", mods = "LEADER", action = act.SplitPane({ direction = "Down", size = { Percent = 30 } }) },
...
local key_tables = {
	...
	setting_mode = {
		...
		{ key = "1", action = set_pane_width_percent(0.1) },
		{ key = "2", action = set_pane_width_percent(0.2) },
		{ key = "3", action = set_pane_width_percent(0.3) },
		{ key = "4", action = set_pane_width_percent(0.4) },
		{ key = "5", action = set_pane_width_percent(0.5) },
		{ key = "6", action = set_pane_width_percent(0.6) },
		{ key = "7", action = set_pane_width_percent(0.7) },
		{ key = "8", action = set_pane_width_percent(0.8) },
		{ key = "9", action = set_pane_width_percent(0.9) },

		-- ペインの幅をパーセンテージで設定
		{ key = "1", mods = "ALT", action = set_pane_height_percent(0.1) },
		{ key = "2", mods = "ALT", action = set_pane_height_percent(0.2) },
		{ key = "3", mods = "ALT", action = set_pane_height_percent(0.3) },
		{ key = "4", mods = "ALT", action = set_pane_height_percent(0.4) },
		{ key = "5", mods = "ALT", action = set_pane_height_percent(0.5) },
		{ key = "6", mods = "ALT", action = set_pane_height_percent(0.6) },
		{ key = "7", mods = "ALT", action = set_pane_height_percent(0.7) },
		{ key = "8", mods = "ALT", action = set_pane_height_percent(0.8) },
		{ key = "9", mods = "ALT", action = set_pane_height_percent(0.9) },
...
wezterm.on("augment-command-palette", function(window, pane)
	...
	local commands = {
		...
		{
			brief = "Launch: Open Code",
			icon = "md_robot_outline",
			action = spawn_overlay_pane("opencode"),
		},
		{
